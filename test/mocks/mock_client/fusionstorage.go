...
// IsSupportDynamicLinks mocks base method.
func (m *MockIRestClient) IsSupportDynamicLinks(ctx context.Context, hostname string) (bool, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "IsSupportDynamicLinks", ctx, hostname)
	ret0, _ := ret[0].(bool)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}

// IsSupportDynamicLinks indicates an expected call of IsSupportDynamicLinks.
func (mr *MockIRestClientMockRecorder) IsSupportDynamicLinks(ctx, hostname any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "IsSupportDynamicLinks",
		reflect.TypeOf((*MockIRestClient)(nil).IsSupportDynamicLinks), ctx, hostname)
}
...
// QueryDynamicLinks mocks base method.
func (m *MockIRestClient) QueryDynamicLinks(ctx context.Context, poolName, hostname string,
	amount int) ([]*client.IscsiLink, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "QueryDynamicLinks", ctx, poolName, hostname, amount)
	ret0, _ := ret[0].([]*client.IscsiLink)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}

// QueryDynamicLinks indicates an expected call of QueryDynamicLinks.
func (mr *MockIRestClientMockRecorder) QueryDynamicLinks(ctx, poolName, hostname, amount any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "QueryDynamicLinks",
		reflect.TypeOf((*MockIRestClient)(nil).QueryDynamicLinks), ctx, poolName, hostname, amount)
}
