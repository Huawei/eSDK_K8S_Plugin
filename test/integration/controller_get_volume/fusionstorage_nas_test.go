...
func TestControllerGetVolume_FusionStorageNas_Success(t *testing.T) {
	// Arrange
	data := fakeFusionStorageNasData()
...
func TestControllerGetVolume_FusionStorageNas_NotFound(t *testing.T) {
	// Arrange
	data := fakeFusionStorageNasData()
	ctx := context.Background()
	mockCtrl := gomock.NewController(t)
...
func TestControllerGetVolume_FusionStorageNas_APIError(t *testing.T) {
	// Arrange
	data := fakeFusionStorageNasData()
	ctx := context.Background()
	mockCtrl := gomock.NewController(t)
...
func fakeFusionStorageNasData() *fusionstorageNasData {
	return &fusionstorageNasData{
		BackendName: "fusionstorage-nas-backend",
		VolumeName:  "test-nas",
		VolumeId:    "fusionstorage-nas-backend.test-nas",
	}
}

type fusionstorageNasData struct {
	BackendName string
	VolumeName  string
	VolumeId    string
}

func (d *fusionstorageNasData) request() *csi.ControllerGetVolumeRequest {
	return &csi.ControllerGetVolumeRequest{VolumeId: d.VolumeId}
}

func (d *fusionstorageNasData) backend(cli client.IRestClient) model.Backend {
