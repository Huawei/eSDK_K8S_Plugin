...
// RoCEClient defines client implements the RoCE interface
type RoCEClient struct {
	RestClientInterface
}

// GetRoCEInitiator used for get RoCE initiator
func (cli *RoCEClient) GetRoCEInitiator(ctx context.Context, initiator string) (map[string]interface{}, error) {
...
// GetRoCEInitiatorByID used for get RoCE initiator by id
func (cli *RoCEClient) GetRoCEInitiatorByID(ctx context.Context, initiator string) (map[string]interface{}, error) {
	id := URL.QueryEscape(strings.Replace(initiator, ":", "\\:", -1))
...
// AddRoCEInitiator used for add RoCE initiator
func (cli *RoCEClient) AddRoCEInitiator(ctx context.Context, initiator string) (map[string]interface{}, error) {
...
// AddRoCEInitiatorToHost used for add RoCE initiator to host
func (cli *RoCEClient) AddRoCEInitiatorToHost(ctx context.Context, initiator, hostID string) error {
	data := map[string]interface{}{
		"ID":               hostID,
