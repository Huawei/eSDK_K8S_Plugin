...
// HostClient defines client implements the Host interface
type HostClient struct {
	RestClientInterface
}

// AddHostToGroup used for add host to group
func (cli *HostClient) AddHostToGroup(ctx context.Context, hostID, hostGroupID string) error {
...
// RemoveHostFromGroup used for remove host from group
func (cli *HostClient) RemoveHostFromGroup(ctx context.Context, hostID, hostGroupID string) error {
	data := map[string]interface{}{
		"ID":               hostGroupID,
		"ASSOCIATEOBJTYPE": 21,
		"ASSOCIATEOBJID":   hostID,
...
// QueryAssociateHostGroup used for query associate host group
func (cli *HostClient) QueryAssociateHostGroup(ctx context.Context, objType int, objID string) ([]interface{}, error) {
...
// CreateHost used for create  host
func (cli *HostClient) CreateHost(ctx context.Context, name string) (map[string]interface{}, error) {
	data := map[string]interface{}{
		"NAME":            name,
		"OPERATIONSYSTEM": 0,
	}
...
// UpdateHost used for update host
func (cli *HostClient) UpdateHost(ctx context.Context, id string, alua map[string]interface{}) error {
...
// GetHostByName used to get host by name
func (cli *HostClient) GetHostByName(ctx context.Context, name string) (map[string]interface{}, error) {
...
// DeleteHost used for delete host by id
func (cli *HostClient) DeleteHost(ctx context.Context, id string) error {
	url := fmt.Sprintf("/host/%s", id)
...
// CreateHostGroup used for create host group
func (cli *HostClient) CreateHostGroup(ctx context.Context, name string) (map[string]interface{}, error) {
	data := map[string]interface{}{
		"NAME": name,
	}
...
// GetHostGroupByName used for get host group by name
func (cli *HostClient) GetHostGroupByName(ctx context.Context, name string) (map[string]interface{}, error) {
...
// DeleteHostGroup used for delete host group
func (cli *HostClient) DeleteHostGroup(ctx context.Context, id string) error {
