...
// FCClient defines client implements the FC interface
type FCClient struct {
	RestClientInterface
}

// QueryFCInitiatorByHost used for get fc initiator by host id
func (cli *FCClient) QueryFCInitiatorByHost(ctx context.Context, hostID string) ([]interface{}, error) {
...
func (cli *FCClient) GetFCInitiator(ctx context.Context, wwn string) (map[string]interface{}, error) {
...
// UpdateFCInitiator used for update fc initiator
func (cli *FCClient) UpdateFCInitiator(ctx context.Context, wwn string, alua map[string]interface{}) error {
	url := fmt.Sprintf("/fc_initiator/%s", wwn)
...
// AddFCInitiatorToHost used for add fc initiator to host
func (cli *FCClient) AddFCInitiatorToHost(ctx context.Context, initiator, hostID string) error {
...
// GetFCTargetWWNs used for get fc target WWNs
func (cli *FCClient) GetFCTargetWWNs(ctx context.Context, initiatorWWN string) ([]string, error) {
...
// GetFCHostLink used for get fc host link by host id
func (cli *FCClient) GetFCHostLink(ctx context.Context, hostID string) ([]interface{}, error) {
