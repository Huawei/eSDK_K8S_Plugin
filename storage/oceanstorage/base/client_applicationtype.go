...
// ApplicationTypeClient defines client implements the ApplicationType interface
...
func (cli *ApplicationTypeClient) GetApplicationTypeByName(ctx context.Context, appType string) (string, error) {
	result := ""
