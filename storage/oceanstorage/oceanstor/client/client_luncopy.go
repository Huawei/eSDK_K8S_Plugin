...
// CreateLunCopy used for create lun copy
func (cli *OceanstorClient) CreateLunCopy(ctx context.Context, name, srcLunID, dstLunID string, copySpeed int) (
...
// GetLunCopyByID used for get lun copy by id
func (cli *OceanstorClient) GetLunCopyByID(ctx context.Context, lunCopyID string) (map[string]interface{}, error) {
...
// GetLunCopyByName used for get lun copy by name
func (cli *OceanstorClient) GetLunCopyByName(ctx context.Context, name string) (map[string]interface{}, error) {
...
// StartLunCopy used for start lun copy
func (cli *OceanstorClient) StartLunCopy(ctx context.Context, lunCopyID string) error {
	data := map[string]interface{}{
		"ID": lunCopyID,
	}
...
// StopLunCopy used for stop lun copy
func (cli *OceanstorClient) StopLunCopy(ctx context.Context, lunCopyID string) error {
	data := map[string]interface{}{
		"ID": lunCopyID,
	}
...
// DeleteLunCopy used for delete lun copy by id
func (cli *OceanstorClient) DeleteLunCopy(ctx context.Context, lunCopyID string) error {
	url := fmt.Sprintf("/LUNCOPY/%s", lunCopyID)
