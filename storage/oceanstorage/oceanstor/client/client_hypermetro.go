...
// GetHyperMetroDomainByName used for get hyper metro domain by name
func (cli *OceanstorClient) GetHyperMetroDomainByName(ctx context.Context,
...
// GetHyperMetroDomain used for get hyper metro domain by domain id
func (cli *OceanstorClient) GetHyperMetroDomain(ctx context.Context, domainID string) (map[string]interface{}, error) {
...
// GetFSHyperMetroDomain used for get file system hyper metro domain by domain name
func (cli *OceanstorClient) GetFSHyperMetroDomain(ctx context.Context,
	domainName string) (map[string]interface{}, error) {
...
// GetHyperMetroPair used for get hyper metro pair by pair id
func (cli *OceanstorClient) GetHyperMetroPair(ctx context.Context, pairID string) (map[string]interface{}, error) {
...
// GetHyperMetroPairByLocalObjID used for get hyper metro pair by local object id
func (cli *OceanstorClient) GetHyperMetroPairByLocalObjID(ctx context.Context, objID string) (map[string]any, error) {
...
// CreateHyperMetroPair used for create hyper metro pair
func (cli *OceanstorClient) CreateHyperMetroPair(ctx context.Context, data map[string]interface{}) (
...
// SyncHyperMetroPair used for synchronize hyper metro pair
func (cli *OceanstorClient) SyncHyperMetroPair(ctx context.Context, pairID string) error {
...
// StopHyperMetroPair used for stop hyper metro pair
func (cli *OceanstorClient) StopHyperMetroPair(ctx context.Context, pairID string) error {
	data := map[string]interface{}{
		"ID": pairID,
	}
...
// DeleteHyperMetroPair used for delete hyper metro pair by pair id
func (cli *OceanstorClient) DeleteHyperMetroPair(ctx context.Context, pairID string, onlineDelete bool) error {
