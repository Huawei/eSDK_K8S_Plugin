...
// DeleteClonePair used for delete clone pair
func (cli *OceanstorClient) DeleteClonePair(ctx context.Context, clonePairID string) error {
...
// GetClonePairInfo used for get clone pair info
func (cli *OceanstorClient) GetClonePairInfo(ctx context.Context, clonePairID string) (map[string]interface{}, error) {
...
// CreateClonePair used for create clone pair
func (cli *OceanstorClient) CreateClonePair(ctx context.Context,
...
// SyncClonePair used for synchronize clone pair
func (cli *OceanstorClient) SyncClonePair(ctx context.Context, clonePairID string) error {
	data := map[string]interface{}{
		"ID":         clonePairID,
		"copyAction": 0,
	}
...
// StopCloneFSSplit used for stop clone split
func (cli *OceanstorClient) StopCloneFSSplit(ctx context.Context, fsID string) error {
	data := map[string]interface{}{
		"ID":          fsID,
		"SPLITENABLE": false,
	}
...
// SplitCloneFS used to split clone
func (cli *OceanstorClient) SplitCloneFS(ctx context.Context,
...
// CloneFileSystem used for clone file system
func (cli *OceanstorClient) CloneFileSystem(ctx context.Context, name string, allocType int, parentID,
