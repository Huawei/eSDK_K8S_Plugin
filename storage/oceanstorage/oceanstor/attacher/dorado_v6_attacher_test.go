...
func TestDoradoV6Attacher_ControllerAttach_Success(t *testing.T) {
	// arrange
	...
	// action
	getRes, getErr := v6Attacher.ControllerAttach(context.Background(), namespaceName, parameters)
