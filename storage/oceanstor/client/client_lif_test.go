...
func mockCli() *client.BaseClient {
...
func responseOfLif(rawResp string) client.Response {
...
func TestBaseClient_GetLogicPort(t *testing.T) {
	...
	t.Run("success", func(t *testing.T) {
		...
		// mock
		patches := gomonkey.ApplyMethodReturn(cli, "Get", resp, nil)
		defer patches.Reset()
	...
	t.Run("get error from http", func(t *testing.T) {
		...
		// mock
		patches := gomonkey.ApplyMethodReturn(cli, "Get", nil, assert.AnError)
		defer patches.Reset()
